          ...
          <div class="row no-gutters">
            <div class="col-md-6 bg-primary r-l" style="">
              <div class="p-4 d-flex flex-column h-100">
                <h4 class="mb-3 text-white">Business Directory</h4>
                <div class="text-fade">Blue spruce Directory</div>
            ...
            <div class="col-md-6" id="content-body">
              <div class="p-4">
                ...
                <form class=""  action="{{ url('loginCheck') }}" method="POST" enctype="multipart/form-data">
                <!-- csrf -->
                {{ csrf_field() }}
