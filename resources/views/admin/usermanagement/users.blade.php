        ...
        <div class="padding pt-0 ">
            <div class="table-responsive">
                <table id="datatable" class="table table-theme table-row v-middle" data-plugin="dataTable" style="margin-top: -15px;">
                    <thead>
                        <tr>
                            <th><span class="text-muted">User Name</span></th>
                            <th><span class="text-muted">User Email</span></th>
                    ...
                    <tbody>
                        ...
                        @foreach ($users as $user)
                            <tr>
                                ...
                                <td>
                                    <a href="{{ url('admin/editUser', $user->id)}}" class="btn btn-raised btn-wave w-xs bg-white" style="color:black;">Edit</a>                                    
