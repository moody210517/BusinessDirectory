...
@section('content')     
    <div class="page-container-1" id="page-container">
        <div class="page-title padding pb-0 ">
            ...
            <a href="{{ url('admin/addTime') }}" class="btn btn-raised btn-wave  blue" style="float: right;color: white;">Add Time</a>
            </h2>
        </div>
                ...
                <table id="datatable" class="table table-theme table-row v-middle" data-plugin="dataTable" style="margin-top: -15px;">
                    ...
                    <tbody>
                        ...
                        @foreach ($users as $user)
                            <tr>
                                <td>
                                    <a href="javascript:void(0);" class="item-author ">{{$user->start_time}}</a>
                                </td>
                                <td>
                                    <a href="javascript:void(0);" class="item-author ">{{$user->end_time}}</a>
                                </td>
                                <td>
                                    <a href="javascript:void(0);" class="item-author ">
                                ...
                                <td>
                                    <a href="{{ url('admin/editTime', $user->id)}}" class="btn btn-raised btn-wave w-xs bg-white" style="color:black;">Edit</a>                                    
