...
@section('content')     
    <div class="page-container-1" id="page-container">
        <div class="page-title padding pb-0 ">
            <h2 class="text-md mb-0" style="padding-bottom: 35px;">Advertisement lists
            <a href="{{ url('admin/addAd') }}" class="btn btn-raised btn-wave  blue" style="float: right;color: white;">Add Advertisement</a>
            </h2>
        </div>
                    ...
                    <tbody>
                        ...
                        @foreach ($users as $user)
                            <tr>
                                ...
                                <td>
                                    <a href="{{ url('admin/editAd', $user->id)}}" class="btn btn-raised btn-wave w-xs bg-white" style="color:black;">Edit</a>                                    
